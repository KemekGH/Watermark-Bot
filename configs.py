...
class Config(object):
	BOT_TOKEN = os.environ.get("BOT_TOKEN", "66666")
	API_ID = int(os.environ.get("API_ID", "12345"))
	API_HASH = os.environ.get("API_HASH", "Efuwii67")
	...
	DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb")
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Helps](https://t.me/Leethaxor).__
