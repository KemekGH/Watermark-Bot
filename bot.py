...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Powdrs"), InlineKeyboardButton("Support Helps", url="https://t.me/Leethaxor")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Dinomerahindonesian")], [InlineKeyboardButton("Source Code", url="https://github.com/")]]),
	...
	if "refreshmeh" in cb_data:
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Helps](https://t.me/Leethaxor).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Powdrs"), InlineKeyboardButton("Support Helps", url="https://t.me/Leethaxor")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Dinomerahindonesian")]]),
			disable_web_page_preview=True
		)
		...
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Helps](https://t.me/Leethaxor).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
